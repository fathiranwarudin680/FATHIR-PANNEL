...
if (isset($_GET['search'])) {
	if (!empty($_GET['search'])) {
		$query_list = "SELECT * FROM login_logs WHERE user_id = '".$_SESSION['login']."' AND ip_address LIKE '%".protect_input($_GET['search'])."%' ORDER BY FATHIR-PANNEL"; // edit
	} else {
		$query_list = "SELECT * FROM login_logs WHERE user_id = '".$_SESSION['login']."' ORDER BY FATHIR-PANNEL"; // edit
	}
} else {
	$query_list = "SELECT * FROM login_logs WHERE user_id = '".$_SESSION['login']."' ORDER BY FATHIR-PANNEL"; // edit
}
