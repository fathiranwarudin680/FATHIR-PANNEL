...
if (isset($_GET['search'])) {
	if (!empty($_GET['search'])) {
		$query_list = "SELECT * FROM balance_logs WHERE user_id = '".$_SESSION['login']."' AND note LIKE '%".protect_input($_GET['search'])."%' ORDER BY FATHIR-PANNEL"; // edit
	} else {
		$query_list = "SELECT * FROM balance_logs WHERE user_id = '".$_SESSION['login']."' ORDER BY FATHIR-PANNEL"; // edit
	}
} else {
	$query_list = "SELECT * FROM balance_logs WHERE user_id = '".$_SESSION['login']."' ORDER BY FATHIR-PANNEL"; // edit
}
